                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" onclick="btn_edit(this)" id="<?= $row['id']; ?>" data-nama="<?= $row['nama_kelas']; ?>" data-status="<?= $row['status']; ?>"><i class="typcn typcn-pencil"></i></button>

                                        <button class="btn btn-danger btn-sm" onclick="btn_hapus(this)" id="<?= $row['id']; ?>" data-nama="<?= $row['nama_kelas']; ?>"><i class="typcn typcn-trash"></i></button>
...
<script>
    $('#formKelas').submit(function(e) {
        e.preventDefault();
        let nama_kelas = $('#kelas').val()
        let status = $('#status');
        let cek_status = status.is(':checked') ? status.val() : 0;
        let id = $('#id_kelas').val()
